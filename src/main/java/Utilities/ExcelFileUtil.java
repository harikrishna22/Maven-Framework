...
public class ExcelFileUtil 
{
	...
	{
		FileInputStream fi = new FileInputStream("E:\\Selenium_Evining\\ERP_Maven\\TestInput\\InputSheet.xlsx");
	...
	public void setCellData(String sheetname , int row ,int column , String status) throws Throwable
	{
		...
		FileOutputStream fo = new FileOutputStream("E:\\Selenium_Evining\\ERP_Maven\\TestOutput\\hybrid1.xlsx");
		wb.write(fo);
		fo.close();
	}
}
