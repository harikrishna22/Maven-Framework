...
public class FunctionLibrary 
{
	...
	public static WebDriver startBrowser() throws Throwable
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "E:\\Selenium_Evining\\ERP_Maven\\CommonDriver\\chromedriver.exe");
    ...
    public static void captureData(WebDriver driver, String locatortype, String locatorvalue) throws Throwable
    {
    	...
    	FileWriter fw= new FileWriter("E:\\Selenium_Evining\\ERP_Stock\\CaptureData\\supplier.txt");
    ...
    {
    	FileReader fr= new FileReader("E:\\Selenium_Evining\\ERP_Maven\\CaptureData\\supplier.txt");
    	BufferedReader br= new BufferedReader(fr);
    	String exp_data= br.readLine();
    	//convert column data into integer
    	int col=Integer.parseInt(testdata);
    	...
    	{
    		String act_data= driver.findElement(By.xpath("//table[@id='tbl_a_supplierslist']/tbody/tr["+i+"]/td["+col+"]/div/span/span")).getText();
    	Thread.sleep(5000);
